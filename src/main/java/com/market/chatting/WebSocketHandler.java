...
public class WebSocketHandler extends TextWebSocketHandler implements InitializingBean {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        // Json객체 → Java객체
        ChattingMessageDTO chatMessage = objectMapper.readValue(msg, ChattingMessageDTO.class);
        
        // 받은 메세지에 담긴 roomId로 해당 채팅방을 찾아온다.
        ChattingRoomDTO chatRoom = cService.selectChatRoom(chatMessage.getRoomId());
